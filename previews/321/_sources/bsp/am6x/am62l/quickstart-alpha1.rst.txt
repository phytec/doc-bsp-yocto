...
.. |yocto-manifestname| replace:: BSP-Yocto-Ampliphy-AM62L-ALPHA1
...
=============================== ================ ================= ==============
BSP-Yocto-Ampliphy-AM62L-ALPHA1   Alpha            2025/06/XX        Unreleased
=============================== ================ ================= ==============
...
- BSP manual - a complete manual on the supported BSP. This includes documentation on
  how to build the BSP, install the built BSP, development tutorials and documentation
  on each board supported peripherals.
...
-  Alpha phyCORE-AM62L FPSC SOM on Alpha Libra Development Board (PD-05035-ALPHA.A0)
