...
Together with `RAUC's HTTP streaming
<https://rauc.readthedocs.io/en/latest/advanced.html#http-streaming>`_, adaptive
updates allow for only downloading necessary data needed for an update.
