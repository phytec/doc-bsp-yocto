...
.. _`static-pdf-dl`: ../../../_static/imx95-quickstart.pdf
...
.. list-table::
   ...
   *  -  .. figure:: /bsp/imx-common/images/power_supply.jpg

            Power Adapter supplying 24V DC/ min. 24W

      -

            USB-A to USB-C Cable

   *  -  .. figure:: /bsp/imx-common/images/ethernet-cable.jpg

            Ethernet Cable

      -  .. figure:: /bsp/imx-common/images/DB9P-female.png

            2.54 10P to DB9P Female

   *  -  .. figure:: /bsp/imx-common/images/DB9P-male.png

            2.54 10P to DB9P Male

      -  .. figure:: /bsp/imx-common/images/micro-sd.png
...
-  Display Add-on Kit (KLCD-AC200 or KLCD-AC209)
-  LVDS Adapter PEB-AV-10
-  phyCAM
...
There are two images available phytec-qt6demo-image and phytec-headless-image.
