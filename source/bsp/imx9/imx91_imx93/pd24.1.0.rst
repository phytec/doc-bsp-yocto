...
.. RAUC
.. |ref-bootloader-offsets-marker| replace:: :ref:`Disable booting from e.MMC boot partitions <mickledore-bootloader-offsets>`
...
.. |ref-supported-hardware| replace:: :ref:`Supported Hardware <imx93-pd24.1.0-supported-hardware>`
...
.. _imx93-pd24.1.0-supported-hardware:
...
*  Connect the target (|ref-debugusbconnector|) and the host with **serial
   cable**
*  Power up the board
*  Open serial port with 115200 baud and 8N1 (you should see u-boot/linux start
   on the console
