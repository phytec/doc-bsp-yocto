...
.. |ref-supported-hardware| replace:: :ref:`Supported Hardware <imx8mm-pd25.1.0-supported-hardware>`
...
==================== ================ ================ ================= ==========
|yocto-manifestname| Major            |yocto-codename| 2025/03/28        Released
==================== ================ ================ ================= ==========

.. include:: ../../intro.rsti

.. _imx8mm-pd25.1.0-supported-hardware:
...
Separate the config names by hash symbols. For example:
