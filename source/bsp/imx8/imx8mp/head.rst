...
.. |wlbt-overlay-file| replace:: /boot/overlays.txt
.. |wlbt-overlay-basename| replace:: overlays.txt
.. |wlbt-overlay-key| replace:: fit_overlay_conf=
...
.. include:: wireless-network.rsti
   :end-before: .. wlbt-intro-marker

WLAN and Bluetooth on the |sbc| are provided by either the PEB-WLBT-05 or the
PEB-WLBT-07 expansion card. Installation instructions can be found in "The
PEB-WLBT-05 for |sbc| Quickstart Guide".

.. include:: wireless-network.rsti
   :start-after: .. wlbt-intro-marker

.. include:: /bsp/peripherals/wireless-network.rsti
   :end-before: .. bluetooth_chapter_start_label

Bluetooth is supported on |sbc| with the PEB-WLBT-05 and PEB-WLBT-07 expansion
cards. How this can be activated is described in the WLAN/Bluetooth section.
