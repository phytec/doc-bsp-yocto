...
.. |wlbt-overlay-file| replace:: /boot/bootenv.txt
.. |wlbt-overlay-basename| replace:: bootenv.txt
.. |wlbt-overlay-key| replace:: overlays=
...
.. include:: wireless-network.rsti
   :start-after: .. wlbt-05-body-marker
   :end-before: .. wlbt-07-marker
