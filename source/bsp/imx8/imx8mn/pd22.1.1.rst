...
.. code-block:: console
   ...
   target:~$ ssh <USER>@192.168.3.10 "dd if=<path_to_file>/|yocto-imagename|-|yocto-machinename|.wic" | dd of=/dev/|emmcdev|
...
.. code-block:: console
   ...
   host:~$ dd if=|yocto-imagename|-|yocto-machinename|.wic status=progress | ssh root@192.168.3.11 "dd of=/dev/|emmcdev|"
...
*  Write the image to the phyCORE-|soc| eMMC (MMC device 2 without partition):
   ...
   .. code-block:: console
      ...
      target:~$ dd if=|yocto-imagename|-|yocto-machinename|.wic of=/dev/|emmcdev|
