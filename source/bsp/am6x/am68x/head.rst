...
If you already built our BSP with Yocto, you can get the bl31.bin and binary
blobs from the directory mentioned here: |ref-bsp-images|
...
- R5 core:
   ...
   .. code-block:: console
      ...
      host:~/|u-boot-repo-name|$ make BINMAN_INDIRS=/path/to/binary_blobs
...
- A72 core:
   ...
   .. code-block:: console
      ...
      host:~/|u-boot-repo-name|$ make BL31=/path/to/bl31.bin BINMAN_INDIRS=/path/to/binary_blobs TEE=/path/to/tee-raw.bin
