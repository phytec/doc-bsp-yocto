...
.. Bootloader
.. |u-boot-defconfig| replace:: phycore_am68x_a72_defconfig
...
*  **tispl.bin**:
   The second bootloader image, loaded by the R5 SBL, contains the ARM Trusted
...
.. code-block::
   ...
   k3-am68-phyboard-izar-lvds-ac199.dtbo
...
The AM68x/TDA4x SoC provides up to 5 UART units. On the |sbc|, TTL level signals
...
:linux-phytec-ti:`tree/v6.12.35-11.01.05-phy/arch/arm64/boot/dts/ti/k3-am68-phyboard-izar.dts#L358`
...
A GPIO fan can be connected to the |sbc|-|soc|. It cannot be controlled by the
kernel. We use lmsensors with hwmon for this instead. lmsensors reads the
temperature periodically and enables or disables the fan at a configurable
