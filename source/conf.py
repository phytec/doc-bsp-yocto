...
latex_documents = [
    (
        ...
        'imx8mp-head.tex',
        'phyCORE-i.MX 8M Plus BSP Manual DRAFT',
    ...
    (
        ...
        'imx8mp-pd24.1.2.tex',
        'phyCORE-i.MX 8M Plus BSP Manual PD24.1.2',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    (
        ...
        'imx8mp-pd24.1.1.tex',
        'phyCORE-i.MX 8M Plus BSP Manual PD24.1.1',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    (
        ...
        'imx8mp-pd23.1.0.tex',
        'phyCORE-i.MX 8M Plus BSP Manual PD23.1.0',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    (
        ...
        'imx8mp-pd22.1.2.tex',
        'phyCORE-i.MX 8M Plus BSP Manual PD22.1.2',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    (
        ...
        'imx8mp-pd22.1.1.tex',
        'phyCORE-i.MX 8M Plus BSP Manual PD22.1.1',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    ...
    (
        'bsp/imx8/imx8mp-fpsc/alpha1',
        'imx8mp-fpsc-alpha1.tex',
    ...
    (
        'bsp/imx8/imx8mm/pd25.1.1',
        'imx8mm-pd25.1.1.tex',
        'phyCORE-i.MX 8M Mini BSP Manual PD25.1.1',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    (
        ...
        'imx8mm-pd25.1.0.tex',
        'phyCORE-i.MX 8M Mini BSP Manual PD25.1.0',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    (
        ...
        'imx8mm-pd23.1.0.tex',
        'phyCORE-i.MX 8M Mini BSP Manual PD23.1.0',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    (
        ...
        'imx8mm-pd22.1.1.tex',
        'phyCORE-i.MX 8M Mini BSP Manual PD22.1.1',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    ...
    (
        ...
        'imx8mn-pd23.1.0.tex',
        'phyCORE-i.MX 8M Nano BSP Manual PD23.1.0',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    (
        ...
        'imx8mn-pd22.1.1.tex',
        'phyCORE-i.MX 8M Nano BSP Manual PD22.1.1',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    ...
    (
        'bsp/imx9/imx91-93/pd26.1.0',
        'imx93-pd26.1.0.tex',
        'phyCORE-i.MX 93 BSP Manual PD26.1.0',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
    ...
    (
        'bsp/am6x/am62l/quickstart-alpha',
        'am62l-quickstart-alpha.tex',
        'phyFLEX-AM62L Quickstart Guide ALPHA',
        'PHYTEC Messtechnik GmbH',
        'manual',
        False,
    ),
