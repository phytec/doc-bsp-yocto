...
L-813e.A9 Yocto Reference Manual (Warrior)
==========================================
...
|                           | Type          | Date          | Status  |
+---------------------------+---------------+---------------+---------+
| BSP-Yocto-i.MX6-PD20.1.0  | Major         | 06.08.2020    | R       |
|                           |               |               | eleased |
+---------------------------+---------------+---------------+---------+
| BSP-Y                     | Major         | 01.07.2020    | R       |
| octo-FSL-i.MX8MM-PD20.1.0 |               |               | eleased |
+---------------------------+---------------+---------------+---------+
...
.. code:: plain
   ...
   http://layers.openembedded.org/layerindex/branch/warrior/layers/
...
.. code:: plain
   ...
   http://www.yoctoproject.org/docs/2.7/bitbake-user-manual/bitbake-user-manual.html
...
.. code:: plain
   ...
   http://www.yoctoproject.org/docs/2.7/toaster-manual/toaster-manual.html#toaster-manual-intro
...
.. code:: plain
   ...
   http://www.yoctoproject.org/docs/2.7/mega-manual/mega-manual.html
...
.. code:: plain
   ...
   http://www.yoctoproject.org/docs/2.7/ref-manual/ref-manual.html#detailed-supported-distros
...
section `Images <#L813e.A9YoctoReferenceManual(Warrior)-images>`__ for
...
.. code:: plain
   ...
   host$ MACHINE=phyboard-mira-imx6-11 ./phyLinux init -p imx6 -r PD20.1-rc1
...
.. code:: plain
   ...
   host$ ./phyLinux init -p master -r warrior
...
Layer <#L813e.A9YoctoReferenceManual(Warrior)-createlayer>`__.
...
References: Yocto 2.7 Docu - Customizing Images Using local.conf
...
-  Yocto 2.7 - Devtool or Devtool Quick Reference
...
a*\ nd the interface files in the
...
configurations, see section `Changing the Network
Configuration <#L813e.A9YoctoReferenceManual(Warrior)-ChangingtheNetworkConfiguration>`__.
...
.. code:: plain
   ...
   http://www.yoctoproject.org/docs/2.7/dev-manual/dev-manual.html

The chapter about common tasks is a good starting point.

.. code:: plain

   http://www.yoctoproject.org/docs/2.7/dev-manual/dev-manual.html#extendpoky
